package novli.auth.authentication.core.filter;

import lombok.extern.slf4j.Slf4j;
import novli.auth.authentication.core.SecurityProperties;
import novli.auth.authentication.core.expection.ValidateCodeException;
...
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    @Autowired
    AuthenticationFailureHandler securityFailureHandler;
